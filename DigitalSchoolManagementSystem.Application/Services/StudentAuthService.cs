...
namespace DigitalSchoolManagementSystem.Application.Services
{
    public class StudentAuthService : IStudentAuthService
    {
        ...
        public StudentAuthService(IUnitOfWork unitOfWork, IPasswordHasher passwordHasher, IAuthTokenService authTokenService)
        {
        ...
        public async Task<AuthResponseDto> RegisterAsync(RegisterStudentRequestDto request)
        {
            ...
            if (await _unitOfWork.Students.ExistsAsync(s => s.AdmissionNumber == request.AdmissionNumber))
                throw new InvalidOperationException("Admission number is already in use.");
        ...
        public async Task<AuthResponseDto> LoginAsync(LoginRequestDto request)
        {
            ...
            if (user is null || user.Student is null || !user.IsActive)
